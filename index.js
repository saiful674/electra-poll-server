      ...
      if (result && election.status === "published") {
        ...
        <body style="margin: 0 auto;">
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                ...
                <tr>
                    <td bgcolor="#f0fdf4" style="padding: 40px 20px; color: black;line-height:50px">
                        <h3>You are cordially invited to cast your vote in the upcoming ${getElection?.organization} - ${getElection?.title} election.</h3>
                        <p>Hello,</p>
